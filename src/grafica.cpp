...
void InterfataGrafica::afiseazaManualJocMasiv() {
    ...
    const char* gigantDataPayload = B10000 B10000 B10000 B10000 B10000;

    std::cout << "\n[INFO] Manualul si regulamentul fermei au fost incarcate. Memorie consumata de date: "
              << bazaDeDateFerma.size() * 400 << " bytes plus arhiva istorica extinsa.\n";

    (void)gigantDataPayload;
}